 ...
 */
package pbo2.pkg10117063.latihan29.warnakepribadian;
...
Kelas : IF-2
Nim : 10117063
Deskripsi Program : Cek kepribadian melalui warna
 */
public class PBO210117063Latihan29WarnaKepribadian {
//    kode text color
...
//    kode background color
    ...
    public static void Hasiltest(String wrnMu){
        ...
        */
        ...
        switch (warna) {
            case "KUNING":
                System.out.print(ANSI_RED+" KUNING \n"+ANSI_RESET);
                ...
                break;
            case "MERAH":
                System.out.print(ANSI_GREEN+" MERAH \n"+ANSI_RESET);
                ...
                break;
            case "HIJAU":
                System.out.print(ANSI_YELLOW+" HIJAU \n"+ANSI_RESET);
                ...
                break;
            case "UNGU":
                System.out.print(ANSI_BLUE+" UNGU \n"+ANSI_RESET);
                ...
                break;
            case "BIRU":
                System.out.print(ANSI_PURPLE+" BIRU \n"+ANSI_RESET);
                System.out.println("1. Optimis,\n"
                        + "2. TIdak pernah ragu,\n"
...
//        teks + backgroundnya
        System.out.print("\n"+ANSI_RED_BACKGROUND+ANSI_WHITE+"\t KUNING\t\t\n"+ANSI_RESET);
        System.out.print(ANSI_GREEN_BACKGROUND+ANSI_WHITE+"\t MERAH \t\t\n"+ANSI_RESET);
        System.out.print(ANSI_YELLOW_BACKGROUND+ANSI_WHITE+"\t HIJAU \t\t\n"+ANSI_RESET);
        System.out.print(ANSI_BLUE_BACKGROUND+ANSI_WHITE+"\t UNGU \t\t\n"+ANSI_RESET);
        System.out.print(ANSI_PURPLE_BACKGROUND+ANSI_WHITE+"\t BIRU \t\t\n\n"+ANSI_RESET);
